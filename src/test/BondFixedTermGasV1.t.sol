...
contract BondFixedTermGasV1Test is Test {
    ...
    function setUp() public {
        ...
        teller = new BondFixedTermTeller(treasury, aggregator, guardian, auth);
        ...
        // Approve the auctioneer for the tokens
        vm.prank(alice);
    ...
    function testGas_PurchaseAndRedeemBondToken() public {
        ...
        // Set time past expiry and redeem
        vm.warp(expiry + 1);
        ...
        auctioneer.createMarket(
            abi.encode(
                IBondSDA.MarketParams(
                    ...
                    50_000, // uint256 debtBuffer
                    uint48(7 days), // uint48 vesting (timestamp or duration)
